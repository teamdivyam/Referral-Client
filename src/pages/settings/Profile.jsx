...
export default function Profile() {
  ...
  return (
    <div className="px-4 py-6 lg:px-6 lg:py-8">
      ...
      <div className="flex flex-col space-y-6 justify-between mt-6 border bg-white w-full max-w-[740px] m-auto px-2 py-3 rounded-md md:flex-row md:space-y-0 md:items-center lg:mt-8 lg:py-4 lg:px-6">
      ...
      <div className="mt-6 border bg-white w-full max-w-[740px] m-auto px-4 py-5 rounded-md lg:mt-8 lg:py-6 lg:px-8">
